...
exports.config = {
  ...
  reporters: [
    [
      'cucumberjs-json',
      {
        jsonFolder: `output/${BROWSER}/json/`,
        language: 'en',
      },
    ],
    'spec',
    ...
    [
      'junit',
      {
        outputDir: `output/${BROWSER}/junit-results`,
  ...
  onComplete(exitCode, config, capabilities, results) {
    ...
    if (fs.existsSync(`./output/${BROWSER}/json`)) {
      generate({
        // Required
        // This part needs to be the same path where you store the JSON files
        // default = '.tmp/json/'
        jsonDir: `output/${BROWSER}/json`,
        reportPath: `output/${BROWSER}/report`,
